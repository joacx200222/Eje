...
function PrincipalBody(){
    return(
        ...
        <ul className='PrincipalBody1'>
            ...
            <ul>
                <li><img src="" className='ImagenItem9' alt="imagenitem9"/></li>
                <li><p>Item 1</p></li>
                <li><h6><p>learn more</p></h6></li>
            </ul>
            <ul>
                <li><img src="" className='ImagenItem10' alt="imagenitem10"/></li>
                <li><p>Item 1</p></li>
                <li><h6><p>learn more</p></h6></li>
            </ul>
            <ul>
            ...
            <ul>
                <li><img src="" className='ImagenItem11' alt="imagenitem11"/></li>
                <li><p>Item 1</p></li>
                <li><h6><p>learn more</p></h6></li>
            </ul>
            <ul>
                <li><img src="" className='ImagenItem12' alt="imagenitem12"/></li>
                <li><p>Item 1</p></li>
                <li><h6><p>learn more</p></h6></li>
            </ul>
        </ul>
        ...
        <ul className='PrincipalBody2'>
            <ul>
                <li><img src="" className='ImagenItem13' alt="imagenitem13" /></li>
                <li><p>Colección de items 1: Especiales para regresar al colegio</p></li>
                <li><h6><p><link to ="/"/>learn more</p></h6></li>

            </ul>
            <ul>
                <li><img src="" className='ImagenItem14' alt="imagenitem14" /></li>
                <li><p>Colección de items 2: Especiales para la casa</p></li>
                <li><h6><p>learn more</p></h6></li>

            </ul>
            <ul>
                <li><img src="" className='ImagenItem15' alt="imagenitem15" /></li>
                <li><p>Colección de items 3: Especiales para los pequeños</p></li>
                <li><h6><p>learn more</p></h6></li>
        ...
        <ul className='PrincipalBody3'>
            <ul>
                <li><img src="" className='ImagenItem16' alt="imagenitem16" /></li>
                <li><p>Item 1</p></li>
                <li><h6><p><link to ="/"/>learn more</p></h6></li>

            </ul>
            <ul>
                <li><img src="" className='ImagenItem17' alt="imagenitem17" /></li>
                <li><p>Item 1</p></li>
                <li><h6><p>learn more</p></h6></li>

            </ul>
            <ul>
                <li><img src="" className='ImagenItem18' alt="imagenitem18" /></li>
                <li><p>Item 1</p></li>
                <li><h6><p>learn more</p></h6></li>

            </ul>
            <ul>
                <li><img src="" className='ImagenItem19' alt="imagenitem19" /></li>
                <li><p>Item 1</p></li>
                <li><h6><p>learn more</p></h6></li>

            </ul>
            <ul>
                <li><img src="" className='ImagenItem20' alt="imagenitem20" /></li>
                <li><p>Item 1</p></li>
                <li><h6><p>learn more</p></h6></li>
